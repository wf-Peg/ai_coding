...
class DataObservabilityControllerTest {
    ...
    void overviewReportsEmptyIndexDirectoryWithoutFailing() {
        ...
        DataObservabilityController controller = new DataObservabilityController(configService, mock(FileStorageService.class), mock(ExceptionLogService.class), mock(WikiQueryMetrics.class));
